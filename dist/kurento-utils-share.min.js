...
function insertScriptSrcInHtmlDom(e){var t=document.createElement("script");t.src=e;var n=document.querySelector("script");n.parentNode.insertBefore(t,n)}function importScriptsDependsOnBrowser(){"IE"===browser.name&&insertScriptSrcInHtmlDom("https://cdn.temasys.io/adapterjs/0.15.x/adapter.debug.js")}function noop(e){e&&logger.error(e)}function trackStop(e){e.stop&&e.stop()}function streamStop(e){e.getTracks().forEach(trackStop)}function bufferizeCandidates(e,t){var n=[],r=function(){if("stable"===e.signalingState)for(;n.length;){var t=n.shift();e.addIceCandidate(t.candidate,t.callback,t.callback)}};return function(e,t){"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?t.onsignalingstatechange=e:t.addEventListener("signalingstatechange",e)}(r,e),function(r,i){switch(i=i||t,e.signalingState){case"closed":i(new Error("PeerConnection object is closed"));break;case"stable":if(e.remoteDescription){e.addIceCandidate(r,i,i);break}default:n.push({candidate:r,callback:i})}}}function removeFIDFromOffer(e){var t=e.indexOf("a=ssrc-group:FID");return t>0?e.slice(0,t):e}function getSimulcastInfo(e){var t=e.getVideoTracks();if(!t.length)return logger.warn("No video tracks available in the video stream"),"";var n=["a=x-google-flag:conference","a=ssrc-group:SIM 1 2 3","a=ssrc:1 cname:localVideo","a=ssrc:1 msid:"+e.id+" "+t[0].id,"a=ssrc:1 mslabel:"+e.id,"a=ssrc:1 label:"+t[0].id,"a=ssrc:2 cname:localVideo","a=ssrc:2 msid:"+e.id+" "+t[0].id,"a=ssrc:2 mslabel:"+e.id,"a=ssrc:2 label:"+t[0].id,"a=ssrc:3 cname:localVideo","a=ssrc:3 msid:"+e.id+" "+t[0].id,"a=ssrc:3 mslabel:"+e.id,"a=ssrc:3 label:"+t[0].id];return n.push(""),n.join("\n")}function sleep(e){for(var t=(new Date).getTime(),n=0;n<1e7&&!((new Date).getTime()-t>e);n++);}function setIceCandidateAccordingWebBrowser(e,t){"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?t.onicecandidate=e:t.addEventListener("icecandidate",e)}function WebRtcPeer(e,t,n){function r(){if(s){s.pause();var e=g.getRemoteStreams()[0];s.srcObject=e,logger.debug("Remote stream:",e),"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?s=attachMediaStream(s,e):s.load()}}function i(e){return P&&("Chrome"===browser.name||"Chromium"===browser.name?(logger.debug("Adding multicast info"),e=new RTCSessionDescription({type:e.type,sdp:removeFIDFromOffer(e.sdp)+getSimulcastInfo(l)})):logger.warn("Simulcast is only available in Chrome browser.")),e}function o(){"closed"===g.signalingState&&n('The peer connection object is in "closed" state. This is most likely due to an invocation of the dispose method before accepting in the dialogue'),l&&d&&c.showLocalVideo(),l&&l.getTracks().forEach(function(e){g.addTrack(e,l)}),u&&u.getTracks().forEach(function(e){g.addTrack(e,u)}),n()}if(!(this instanceof WebRtcPeer))return new WebRtcPeer(e,t,n);WebRtcPeer.super_.call(this),t instanceof Function&&(n=t,t=void 0),t=t||{},n=(n||noop).bind(this);var a,c=this,d=t.localVideo,s=t.remoteVideo,l=t.videoStream,u=t.audioStream,f=t.mediaConstraints,g=t.peerConnection,p=t.sendSource||"webcam",b=t.dataChannelConfig,h=t.dataChannels||!1,m=uuidv4(),v=recursive({iceServers:freeice()},t.configuration),S=t.onicecandidate;S&&this.on("icecandidate",S);var w=t.oncandidategatheringdone;w&&this.on("candidategatheringdone",w);var P=t.simulcast,D=t.multistream,R=new sdpTranslator.Interop,y=[],C=!1;if(Object.defineProperties(this,{peerConnection:{get:function(){return g}},id:{value:t.id||m,writable:!1},remoteVideo:{get:function(){return s}},localVideo:{get:function(){return d}},dataChannel:{get:function(){return a}},currentFrame:{get:function(){if(s){if(s.readyState<s.HAVE_CURRENT_DATA)throw new Error("No video stream data available");var e=document.createElement("canvas");return e.width=s.videoWidth,e.height=s.videoHeight,e.getContext("2d").drawImage(s,0,0),e}}}}),!g&&(g=new RTCPeerConnection(v),h&&!a)){var E="WebRtcPeer-"+c.id,A=void 0;b&&(E=b.id||E,A=b.options),a=g.createDataChannel(E,A),b&&(a.onopen=b.onopen,a.onclose=b.onclose,a.onmessage=b.onmessage,a.onbufferedamountlow=b.onbufferedamountlow,a.onerror=b.onerror||noop)}!g.getLocalStreams&&g.getSenders&&(g.getLocalStreams=function(){var e=new MediaStream;return g.getSenders().forEach(function(t){e.addTrack(t.track)}),[e]}),!g.getRemoteStreams&&g.getReceivers&&(g.getRemoteStreams=function(){var e=new MediaStream;return g.getReceivers().forEach(function(t){e.addTrack(t.track)}),[e]}),setIceCandidateAccordingWebBrowser(function(e){var t=e.candidate;if(EventEmitter.listenerCount(c,"icecandidate")||EventEmitter.listenerCount(c,"candidategatheringdone"))if(t){var n;n=D&&usePlanB?R.candidateToUnifiedPlan(t):t,"undefined"==typeof AdapterJS&&c.emit("icecandidate",n),C=!1}else C||("undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?EventEmitter.prototype.emit("candidategatheringdone",n):c.emit("candidategatheringdone"),C=!0);else C||(y.push(t),t||(C=!0))},g),g.onaddstream=t.onaddstream,g.onnegotiationneeded=t.onnegotiationneeded,this.on("newListener",function(e,t){if("icecandidate"===e||"candidategatheringdone"===e)for(;y.length;){var n=y.shift();!n==("candidategatheringdone"===e)&&t(n)}});var W=bufferizeCandidates(g);this.addIceCandidate=function(e,t){var n;n=D&&usePlanB?R.candidateToPlanB(e):new RTCIceCandidate(e),logger.debug("Remote ICE candidate received",e),t=(t||noop).bind(this),W(n,t)},this.generateOffer=function(t){if(t=t.bind(this),"recvonly"===e){var n=!f||"boolean"!=typeof f.audio||f.audio,r=!f||"boolean"!=typeof f.video||f.video;n&&g.addTransceiver("audio",{direction:"recvonly"}),r&&g.addTransceiver("video",{direction:"recvonly"})}else"sendonly"===e&&g.getTransceivers().forEach(function(e){e.direction="sendonly"});if("undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9){var o=function(){sleep(1e3);var e=g.localDescription;logger.debug("Local description set\n",e.sdp),D&&usePlanB&&(e=R.toUnifiedPlan(e),logger.debug("offer::origPlanB->UnifiedPlan",dumpSDP(e))),t(null,e.sdp,c.processAnswer.bind(c))},a=function(e){logger.debug("Created SDP offer"),logger.debug("Local description set\n",g.localDescription),g.setLocalDescription(e,o,t)};g.createOffer(a,t)}else g.createOffer().then(function(e){return logger.debug("Created SDP offer"),e=i(e),g.setLocalDescription(e)}).then(function(){var e=g.localDescription;logger.debug("Local description set\n",e.sdp),D&&usePlanB&&(e=R.toUnifiedPlan(e),logger.debug("offer::origPlanB->UnifiedPlan",dumpSDP(e))),t(null,e.sdp,c.processAnswer.bind(c))}).catch(t)},this.getLocalSessionDescriptor=function(){return g.localDescription},this.getRemoteSessionDescriptor=function(){return g.remoteDescription},this.showLocalVideo=function(){d.srcObject=l,d.muted=!0,"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9&&(d=attachMediaStream(d,l))},this.send=function(e){a&&"open"===a.readyState?a.send(e):logger.warn("Trying to send data over a non-existing or closed data channel")},this.processAnswer=function(e,t){t=(t||noop).bind(this);var n=new RTCSessionDescription({type:"answer",sdp:e});if(D&&usePlanB){var i=R.toPlanB(n);logger.debug("asnwer::planB",dumpSDP(i)),n=i}if(logger.debug("SDP answer received, setting remote description"),"closed"===g.signalingState)return t("PeerConnection is closed");g.setRemoteDescription(n).then(function(){r(),t()},t)},this.processOffer=function(e,t){t=t.bind(this);var n=new RTCSessionDescription({type:"offer",sdp:e});if(D&&usePlanB){var o=R.toPlanB(n);logger.debug("offer::planB",dumpSDP(o)),n=o}if(logger.debug("SDP offer received, setting remote description"),"closed"===g.signalingState)return t("PeerConnection is closed");g.setRemoteDescription(n).then(function(){return r()}).then(function(){return g.createAnswer()}).then(function(e){return e=i(e),logger.debug("Created SDP answer"),g.setLocalDescription(e)}).then(function(){var e=g.localDescription;D&&usePlanB&&(e=R.toUnifiedPlan(e),logger.debug("answer::origPlanB->UnifiedPlan",dumpSDP(e))),logger.debug("Local description set\n",e.sdp),t(null,e.sdp)}).catch(t)},"recvonly"===e||l||u?setTimeout(o,0):"webcam"===p?function(e){void 0===e&&(e=MEDIA_CONSTRAINTS),"undefined"!=typeof AdapterJS&&"IE"===AdapterJS.webrtcDetectedBrowser&&AdapterJS.webrtcDetectedVersion>=9?navigator.getUserMedia(e,function(e){l=e,o()},n):navigator.mediaDevices.getUserMedia(e).then(function(e){l=e,o()}).catch(n)}(f):function(e){void 0===e&&(e=MEDIA_CONSTRAINTS),console.log("[getScreenDisplay][calling getDisplayMedia api].."),navigator.mediaDevices.getDisplayMedia(e).then(function(e){l=e,o()}).catch(n)}(f),this.on("_dispose",function(){d&&(d.pause(),d.srcObject=null,"undefined"==typeof AdapterJS&&d.load(),d.muted=!1),s&&(s.pause(),s.srcObject=null,"undefined"==typeof AdapterJS&&s.load()),c.removeAllListeners(),"undefined"!=typeof window&&void 0!==window.cancelChooseDesktopMedia&&window.cancelChooseDesktopMedia(m)})}function createEnableDescriptor(e){var t="get"+e+"Tracks";return{enumerable:!0,get:function(){if(this.peerConnection){var e=this.peerConnection.getLocalStreams();if(e.length){for(var n,r=0;n=e[r];r++)for(var i,o=n[t](),a=0;i=o[a];a++)if(!i.enabled)return!1;return!0}}},set:function(e){function n(t){t.enabled=e}this.peerConnection.getLocalStreams().forEach(function(e){e[t]().forEach(n)})}}}function WebRtcPeerRecvonly(e,t){if(!(this instanceof WebRtcPeerRecvonly))return new WebRtcPeerRecvonly(e,t);WebRtcPeerRecvonly.super_.call(this,"recvonly",e,t)}function WebRtcPeerSendonly(e,t){if(!(this instanceof WebRtcPeerSendonly))return new WebRtcPeerSendonly(e,t);WebRtcPeerSendonly.super_.call(this,"sendonly",e,t)}function WebRtcPeerSendrecv(e,t){if(!(this instanceof WebRtcPeerSendrecv))return new WebRtcPeerSendrecv(e,t);WebRtcPeerSendrecv.super_.call(this,"sendrecv",e,t)}function harkUtils(e,t){return hark(e,t)}var freeice=require("freeice"),inherits=require("inherits"),UAParser=require("ua-parser-js"),uuidv4=require("uuid/v4"),hark=require("hark"),EventEmitter=require("events").EventEmitter,recursive=require("merge").recursive.bind(void 0,!0),sdpTranslator=require("sdp-translator"),logger="undefined"==typeof window?console:window.Logger||console,MEDIA_CONSTRAINTS={audio:!0,video:{width:640,framerate:15}},ua="undefined"!=typeof window&&window.navigator?window.navigator.userAgent:"",parser=new UAParser(ua),browser=parser.getBrowser();importScriptsDependsOnBrowser();var usePlanB=!1;"Chrome"!==browser.name&&"Chromium"!==browser.name||(logger.debug(browser.name+": using SDP PlanB"),usePlanB=!0);var dumpSDP=function(e){return void 0===e||null===e?"":"type: "+e.type+"\r\n"+e.sdp};inherits(WebRtcPeer,EventEmitter),Object.defineProperties(WebRtcPeer.prototype,{enabled:{enumerable:!0,get:function(){return this.audioEnabled&&this.videoEnabled},set:function(e){this.audioEnabled=this.videoEnabled=e}},audioEnabled:createEnableDescriptor("Audio"),videoEnabled:createEnableDescriptor("Video")}),WebRtcPeer.prototype.getLocalStream=function(e){if(this.peerConnection)return this.peerConnection.getLocalStreams()[e||0]},WebRtcPeer.prototype.getRemoteStream=function(e){if(this.peerConnection)return this.peerConnection.getRemoteStreams()[e||0]},WebRtcPeer.prototype.dispose=function(){logger.debug("Disposing WebRtcPeer");var e=this.peerConnection,t=this.dataChannel;try{if(t){if("closed"===t.readyState)return;t.close()}if(e){if("closed"===e.signalingState)return;e.getLocalStreams().forEach(streamStop),e.close()}}catch(e){logger.warn("Exception disposing webrtc peer "+e)}"undefined"==typeof AdapterJS&&this.emit("_dispose")},inherits(WebRtcPeerRecvonly,WebRtcPeer),inherits(WebRtcPeerSendonly,WebRtcPeer),inherits(WebRtcPeerSendrecv,WebRtcPeer),exports.bufferizeCandidates=bufferizeCandidates,exports.WebRtcPeerRecvonly=WebRtcPeerRecvonly,exports.WebRtcPeerSendonly=WebRtcPeerSendonly,exports.WebRtcPeerSendrecv=WebRtcPeerSendrecv,exports.hark=harkUtils;
